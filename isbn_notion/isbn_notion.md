...
yokoyです。
手元にある書籍をnotionデータベースに登録するショートカットを作成したので
手順を公開します。

https://youtube.com/watch?v=SvSS2BCtgj8?feature=share

データベースに登録する情報は以下の4つです
...
「作るのはめんどくさい」「とにかく早く使いたい」という人は有料版の購入をお願い致します。
...
iPhoneのショートカットを1から作成するのは、触ったことのない人にとってはかなりハードルが高いかと思います。
